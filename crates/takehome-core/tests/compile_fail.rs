//! Compile-fail suite for takehome-core API negatives.
//!
...
#[test]
fn k4p_rejects_annual_taxable_income() {
    let t = trybuild::TestCases::new();
    t.compile_fail("tests/compile_fail/k4p_rejects_annual_taxable_income.rs");
}
